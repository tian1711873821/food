<template>
    <div class="goods">
            ...
            <ul>
              <li @click="selectFood(food,$event)" v-for="food in item.foods" class="food-item border-1px">
                ...
                <div class="content">
                  ...
                  <div class="addshow-wrapper">
                    <addshop :food="food" @change=""></addshop>
                  </div>
                </div>
              </li>
            </ul>
      ...
      <shopcart :selletFoods="selectFoods" :deliveryprice="seller.deliveryPrice" :minprice="seller.minPrice"></shopcart>
