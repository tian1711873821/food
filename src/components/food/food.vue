      ...
      <div v-show="showFlag" class="food" ref="wrapper">
        <div class="food-content" >
          ...
          <div class="rating">
            ...
            <ratingselect @selectclick="clicktype" @onlycont="onlyconent" :select-type="selectType" :only-conent="onlyConent" :desc="desc" :rating="food.ratings">
            </ratingselect>

            <div class="rating-wrapper">
              <ul v-show="food.ratings&&food.ratings.length">
                <li v-show="needShow(rating.rateType,rating.length)" v-for="rating in food.ratings" class="rating-item border-1px">
                  <div class="user">
